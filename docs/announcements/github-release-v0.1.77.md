# 🚀 Release Highlights — v0.1.77 (2026-04-15)

### ⚡ [Answer Now Button](https://docs.massgen.ai/en/latest/user_guide/concepts.html)
- **Faster answers** ([#1062](https://github.com/massgen/MassGen/pull/1062)): New "Answer Now" button lets agents submit answers more quickly, bypassing additional refinement rounds when quality is already sufficient
